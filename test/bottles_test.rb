...
describe Bottles do
  ...
  describe "#song" do
    it "outputs the whole song" do
      @bottles.song.must_equal <<~EOF
  ...
  describe "#verses" do
    it "can output two verses" do
      @bottles.verses(99, 98).must_equal <<~EOF
        99 bottles of beer on the wall
        99 bottles of beer
        Take one down and pass it around
        98 bottles of beer on the wall
    ...
    it "can output multiple verses" do
      @bottles.verses(2, 0).must_equal <<~EOF
        2 bottles of beer on the wall
        2 bottles of beer
        Take one down and pass it around
        1 bottle of beer on the wall
